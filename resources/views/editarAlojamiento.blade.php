        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="container-info">
                    <h2>Descripción general <i class="fas fa-edit fa-2xs"></i></h2>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 p-5">
                                    ...
                                    <p class="lead" contenteditable="true">
                                        ...
                                        Buen viaje!! <i class="fas fa-edit fa-2xs"></i>
                                    </p>
                                    <p>
                                        ...
                                        <div class="card bg-dark text-light">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text">
                                                    ...
                                                    luminoso. Está justo en mitad entre el centro ciudad y la bonita playa
                                                    de El Sardinero.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md">
                                        <div class="card bg-dark text-light">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text">
                                                    El apartamento es como se ve en las imágenes, muy bonito y cómodo. Esta
                                                    super bien ubicado en una zona de playa, cerca de la estación de tren y
                    ...
                    <section id="questions" class="p-5">
                        <div class="container">
                            <h2 class="text-center mb-4">Preguntas frecuentes sobre The Valley Residence <i
                                    class="fas fa-edit fa-2xs"></i></h2>
                            <div class="accordion accordion-flush" id="questions">
                                <!-- Item 1 -->
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#question-one" contenteditable="true">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#question-two" contenteditable="true">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#question-three" contenteditable="true">
